  ...
  return (
    <div className="fixed bottom-6 end-6 z-50 flex flex-col items-end gap-2">
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="px-4 py-2 rounded-xl text-[13px] font-semibold shadow-lg whitespace-nowrap"
      ...
      >
        ...
        <span className="absolute inset-0 rounded-full animate-pulse opacity-20" style={{ backgroundColor: '#25D366' }} />
